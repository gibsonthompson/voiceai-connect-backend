...
const reconcileVercelDomains = require('./routes/reconcile-vercel-domains');
...
const smsTemplatesAdminRoutes = require('./routes/sms-templates-admin');
...
app.use('/api/cron', reconcileVercelDomains);
