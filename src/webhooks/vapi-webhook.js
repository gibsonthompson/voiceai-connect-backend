...
async function generateAISummary(transcript, industry, callerPhone) {
  ...
  const industryGuidance = {
    ...
    hvac: 'Focus on: heating vs cooling vs air-quality issue, whether there is any heat or cooling right now, property location, urgency (no heat in cold, no cooling in heat, gas or CO concern).',
    plumbing: 'Focus on: the problem (leak, clog, no hot water, sewer), whether water is active right now, location, urgency.',
    electrical: 'Focus on: the issue (breaker, outlet, lights, or project), any burning smell, sparks, or smoke, location, safety and urgency.',
    roofing: 'Focus on: leak vs storm damage vs replacement, whether water is coming in right now, property location, any insurance-claim mention, urgency.',
    pest_control: 'Focus on: the pest, one-time vs recurring, location and severity, any stinging-insect allergy, urgency.',
    landscaping: 'Focus on: service needed (maintenance, cleanup, or design and install), property size, one-time vs recurring, timeline.'
  };
